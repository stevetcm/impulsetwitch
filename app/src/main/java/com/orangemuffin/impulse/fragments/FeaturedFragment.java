...
public class FeaturedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        streamsListAdapter = new StreamsListAdapter(getContext(), new ArrayList<StreamInfo>(), "featured");
        ...
        callFetchFeaturedTask(); //initial call to task on create
    ...
    private void callFetchFeaturedTask() {
        new FetchFeaturedTask(getContext(), new FetchFeaturedTask.FetchFeaturedCallback() {
            @Override
            public void onFeaturedFetched(List<StreamInfo> streams) {
